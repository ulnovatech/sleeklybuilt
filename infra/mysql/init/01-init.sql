...
# Migrations: docker compose exec php-fpm php /var/www/public_html/sleekly-dash/backend/scripts/apply_admin_mobile_migrations.php

SET NAMES utf8mb4;
SET CHARACTER SET utf8mb4;

-- Placeholder: ensure app can connect; tables created via migrations or manual import.
SELECT 'sleeklybuilt mysql init complete' AS status;
