...
const Rainbow = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(apiEndpoints.developerQuote, {
        method: 'POST',
        headers: {
      ...
      if (response.ok && payload.status === 'success') {
        toast.success(payload.message || 'Thank you! We\'ll review your requirements and get back to you within 24 hours.');
        setFormData({
          name: '',
          email: '',
          company: '',
