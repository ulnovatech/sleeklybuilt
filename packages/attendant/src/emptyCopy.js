...
const BY_PAGE = {
  ...
  policies: "You're in Policies. Ask which policy matters for your project, or how we handle deposits.",
  portfolio: "You're in the projects gallery. Ask me to help pick a layout or how checkout works.",
  'portfolio-order':
    "You're on secure checkout. Ask about deposits, Mobile Money, or what's included before you pay.",
  blog: "You're on the SleeklyBuilt blog. Ask about an article topic, or how to start a project.",
  'blog-list': "You're browsing blog posts. Ask about a topic, or jump to pricing or layouts.",
  'blog-about': "You're on the blog About page. Ask what we build, or how to get started.",
  'blog-contact': "You're on blog Contact. Tell me what you need — or open WhatsApp.",
  'blog-post': "You're reading a SleeklyBuilt article. Ask about the topic, or how we can help your business.",
