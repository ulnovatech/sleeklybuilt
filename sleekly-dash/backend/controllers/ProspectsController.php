    ...
    public function convertToCompany($id)
    {
        ...
        try {
            $ins = $this->pdo->prepare('
                ...
                (name, industry, website_url, has_website, location, contact_person, contact_method, contact_phone, contact_email, contact_whatsapp, status, priority, last_contact_date, notes, discovery_account_id)
                VALUES
                (:name, :industry, :website_url, :has_website, :location, :contact_person, :contact_method, :contact_phone, :contact_email, :contact_whatsapp, :status, :priority, :last_contact_date, :notes, :discovery_account_id)
            ');
            $notes = $p['notes'] ?? '';
            ...
            $ins->execute([
                ...
                ':notes' => $notes ?: null,
                ':discovery_account_id' => $p['discovery_account_id'] ?? null,
            ]);
